...
contract MintFactory is ERC721, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public _reflectionShare = 10;
    ...
    uint public _reservedTokens = 300;
    uint256 _mintPrice = 10000000000000000;
    uint256 _totalClaimable = 0;
    uint256 _marketplaceVolume = 0;
    uint256 _minterFee = 0;
    ...
    constructor() ERC721("Crayon Chimp Club", "CHIMPZ") {
        setBaseURI("ipfs/QmbpXy5MKifHUAi1nmbcWTvbpMUAJvNz6itMy7Krbk6Vmf");
        _owner = msg.sender;
    ...
    function mintNFT(uint256 maxNFT) public payable {
        ...
        require(
            maxNFT > 0 && maxNFT <= 20,
            "You must mint a minimum 1 and maximum of 20"
        );
        ...
        for (uint256 i = 0; i < maxNFT; i++) {
            ...
            _lastDividend[mintIndex] = totalDividend;
        }
    }
